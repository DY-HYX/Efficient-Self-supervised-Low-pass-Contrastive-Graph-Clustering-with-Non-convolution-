...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='Salinas', help='type of dataset.')  # 'Indian', 'Salinas', 'PaviaU'  'Houston','Trento'
    parser.add_argument('--superpixel_scale', type=int, default=300, help="superpixel_scale") # IP 100 sa  250  pu160  Tr900  HU100
