...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='Indian', help='type of dataset.')  # 'Indian', 'Salinas', 'PaviaU'  'Houston','Trento'
    parser.add_argument('--superpixel_scale', type=int, default=200, help="superpixel_scale") # IP 100 sa  250  pu160  Tr900  HU100
    ...
    ls = LDA_SLIC_IP.LDA_SLIC(input_numpy,gt_hsi, num_classes - 1)
    Q, S, A, Edge_index, Edge_atter, Seg, A_ones = ls.simple_superpixel(scale=args.superpixel_scale)
